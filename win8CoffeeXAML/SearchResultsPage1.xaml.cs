...
namespace win8CoffeeXAML
{
    ...
    //                 frame = new Frame();
    //                 win8CoffeeXAML.Common.SuspensionManager.RegisterFrame(frame, "AppFrame");
    // 
    ...
    //                      try
    //                     {
    //                         await win8CoffeeXAML.Common.SuspensionManager.RestoreAsync();
    //                     }
    //                     catch (win8CoffeeXAML.Common.SuspensionManagerException)
    //                     {
    ...
    /// </summary>
    public sealed partial class SearchResultsPage1 : win8CoffeeXAML.Common.LayoutAwarePage
    {
        ...
        /// </summary>
        private sealed class Filter : win8CoffeeXAML.Common.BindableBase
        {
